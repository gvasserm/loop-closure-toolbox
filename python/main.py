...
def main():     
   exec_eval_mode(dataset_name, vpr_dataset_directory,vpr_precomputed_matches_directory, VPR_techniques, save_matching_info, scale_percent)
     
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('-em','--evalmode', required=False, default=0, help='Specify Evaluation Mode (Possible value can be either of 0/1/2/3)', type=int)
    parser.add_argument('-sm','--savematchinginfo', required=False, default=0, help='Flag for storing matching data after computation (Possible value can be 0/1)', type=int)
    ...
    parser.add_argument('-techs','--VPRtechniquenames', default=["HOG"], nargs='+', help='List of names of VPR techniques which could be any of these (NetVLAD,RegionVLAD,CoHOG,HOG,AlexNet_VPR,AMOSNet,HybridNet,CALC)', required=False, type=str)

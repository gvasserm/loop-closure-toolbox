...
#                    scale_percent = 100 # percent (0-100) of original size
            ...
            precomputed_data=[np.asarray(query_indices_list), np.asarray(matching_indices_list), np.asarray(matching_scores_list), np.asarray(all_retrievedindices_scores_allqueries), encoding_time/itr, matching_time/itr]

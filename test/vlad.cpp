...
#define COLUMNOFCODEBOOK 971814 //码本大小
...
int main(int argc, char **argv)
{
	...
	try {
		...
		files = std::move(loadImagePaths("/home/gvasserm/dev/loop-closure-toolbox/assets/01"));
		retFiles = std::move(loadImagePaths("/home/gvasserm/dev/loop-closure-toolbox/assets/01"));
		...
		//建立码本
		DBoW3::Vocabulary voc("./config/orbvoc.dbow3");
